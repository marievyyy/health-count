    ...
    <!-- Menu -->
        ...
        <div class="container page">
            ...
            <div class="row second">
                <div class="col-md-6">
                    <img src="../application/views/img/about1.jpeg">
                </div>
            ...
            <div class="row us" align="center">
                <div class="col-md-4">
                    <img src="../application/views/img/bunquin.jpg">
                    <h2>Ryan Grabriel S. Bunquin</h2>
                    <h3>Lead Back End Developer</h3>
                </div>
                <div class="col-md-4">
                    <img src="../application/views/img/malto.jpg">
                    <h2>Allison Dwight R. Malto</h2>
                    <h3>Back End Developer Assitant</h3>
                </div>
                <div class="col-md-4">
                    <img src="../application/views/img/lapitan.jpg">
            ...
            <div class="row us" align="center">
                <div class="col-md-6">
                    <img src="../application/views/img/porras.jpg">
                    <h2>Ivy Marie G. Porras</h2>
                    <h3>Lead Front End Developer</h3>
                </div>
                <div class="col-md-6">
                    <img src="../application/views/img/palambiano.jpg">
